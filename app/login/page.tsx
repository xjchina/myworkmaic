    ...
    <AppShell activeKey="login" title="登录" description="使用验证码或密码登录">
      <div className="auth-wrapper">
        <div className="auth-card">
          ...
          {method === 'code' ? (
            <div className="field">
              ...
              <div className="input-row">
                ...
                <button type="button" className="code-btn" disabled={cooldown > 0 || !isValidPhone(normalizedPhone)} onClick={onSendCode}>
          ...
          <button type="button" className="btn submit-btn" onClick={onSubmit} disabled={submitting || !agreed || !canSubmit}>
      ...
      <style jsx>{`
        ...
        .method-tabs { display: inline-flex; background: #f1f5f9; border-radius: 10px; padding: 3px; margin-bottom: 16px; }
        .method-tab { border: none; background: transparent; color: #64748b; padding: 8px 16px; border-radius: 8px; cursor: pointer; font-size: 13px; font-weight: 600; }
